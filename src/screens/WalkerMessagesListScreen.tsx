...
import { WalkerMessagesStackParamList } from '../navigation/types';
import { colors, radius, spacing } from '../theme/colors';

type Props = NativeStackScreenProps<WalkerMessagesStackParamList, 'MessagesMain'>;

type ThreadRow = { thread: ChatThread; pet: Pet | null; owner: Profile; lastMessage: ChatMessageRow | null };

export default function WalkerMessagesListScreen({ navigation }: Props) {
  ...
  return (
    <ScreenContainer>
      ...
      <Text style={styles.subtitle}>Conversations with pet owners</Text>
